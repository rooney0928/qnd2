...
public class DownloadUtil {
    ...
    private void installAPK() {
        ...
        if (downloadFileUri != null) {
            String filePath = UriTool.getRealPathFromUri(mContext,downloadFileUri);
            LogU.t("path:"+filePath);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri contentUri = FileProvider.getUriForFile( mContext, "qunadai", apkFile);
